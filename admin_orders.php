...
if(isset($_POST['update_order'])){
   ...
   mysqli_query($conn, "UPDATE `orders` SET status = '$update_payment' WHERE orderID = '$order_update_id'") or die('query failed');
...
<section class="orders">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p> total products : <span><?php echo $fetch_orders['quantity']; ?></span> </p>
